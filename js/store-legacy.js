...
/* harmony import */ var _api_area__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/api/area */ "./src/api/area/index.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/components */ "./src/components/index.js");
/* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules */ "./src/views/area/modules/index.js");
/* harmony import */ var _amap_amap_jsapi_loader__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @amap/amap-jsapi-loader */ "./node_modules/@amap/amap-jsapi-loader/dist/index.js");
/* harmony import */ var _amap_amap_jsapi_loader__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_amap_amap_jsapi_loader__WEBPACK_IMPORTED_MODULE_12__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Index',
  components: {
    STable: _components__WEBPACK_IMPORTED_MODULE_10__.STable,
    AddForm: _modules__WEBPACK_IMPORTED_MODULE_11__.AddForm,
    EditForm: _modules__WEBPACK_IMPORTED_MODULE_11__.EditForm,
    SelectRegion: _components__WEBPACK_IMPORTED_MODULE_10__.SelectRegion
  },
  computed: {
      ...
      return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_2__["default"])().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _amap_amap_jsapi_loader__WEBPACK_IMPORTED_MODULE_12___default().load({
  ...
  methods: {
      ...
      return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_3__["default"])( /*#__PURE__*/(0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_2__["default"])().mark(function _callee2() {
        ...
        return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_2__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _api_area__WEBPACK_IMPORTED_MODULE_9__.list(_this2.queryParam).then(function (response) {
                return response;
              });
            case 2:
              res = _context2.sent;
              _this2.areasById = lodash__WEBPACK_IMPORTED_MODULE_13___default()(res.data).keyBy('id').value();
              if (res.data.length) {
    ...
    saveArea: function saveArea() {
      ...
      _api_area__WEBPACK_IMPORTED_MODULE_9__.edit(areaId, {
        paths: paths
      }).then(function (res) {
    ...
    handleDelete: function handleDelete(item) {
      ...
      var modal = this.$confirm({
        ...
        content: '删除后不可恢复',
        onOk: function onOk() {
          return _api_area__WEBPACK_IMPORTED_MODULE_9__.deleted(item.id).then(function (result) {
    ...
    handleSetDefault: function handleSetDefault() {
      ...
      this.$confirm({
        ...
        onOk: function onOk() {
          return _api_area__WEBPACK_IMPORTED_MODULE_9__.setDefault(areaId).then(function () {
...
/* harmony import */ var _api_area__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/api/area */ "./src/api/area/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SelectRegion: _components__WEBPACK_IMPORTED_MODULE_4__.SelectRegion
  },
  data: function data() {
    return {
      // 对话框标题
...
/* harmony import */ var _api_area__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/api/area */ "./src/api/area/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SelectRegion: _components__WEBPACK_IMPORTED_MODULE_9__.SelectRegion
  },
  data: function data() {
    return {
      // 对话框标题
  ...
  methods: {
        ...
        return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_2__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return Promise.all([_api_area__WEBPACK_IMPORTED_MODULE_8__.getCategories(record.id), _common_model_Category__WEBPACK_IMPORTED_MODULE_10__["default"].getCategoryTreeSelect()]);
            case 3:
    ...
    */
    onFormSubmit: function onFormSubmit(values) {
      ...
      _api_area__WEBPACK_IMPORTED_MODULE_8__.edit(this.record.id, (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, values), {}, {
        province: province,
        city: city,
        district: district
      })).then(function (result) {
...
/* harmony import */ var _api_wechat__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/api/wechat */ "./src/api/wechat/index.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/components */ "./src/components/index.js");
/* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules */ "./src/views/store/address/modules/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Index',
  components: {
    STable: _components__WEBPACK_IMPORTED_MODULE_7__.STable,
    AddForm: _modules__WEBPACK_IMPORTED_MODULE_8__.AddForm,
    EditForm: _modules__WEBPACK_IMPORTED_MODULE_8__.EditForm,
  ...
  methods: {
    ...
    handleDelete: function handleDelete(item) {
      ...
      var modal = this.$confirm({
        ...
        content: '删除后不可恢复',
        onOk: function onOk() {
          return _api_store_address__WEBPACK_IMPORTED_MODULE_5__.deleted(item.id).then(function (result) {
        ...
        return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 6;
              return _api_wechat__WEBPACK_IMPORTED_MODULE_6__.qrcode('pages/ontheway/scan-store?id=' + item.id);
            case 6:
...
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _api_store_address__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/api/store/address */ "./src/api/store/address.js");
/* harmony import */ var _api_area__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/api/area */ "./src/api/area/index.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/components */ "./src/components/index.js");
/* harmony import */ var _SelectMapPoint__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./SelectMapPoint */ "./src/views/store/address/modules/SelectMapPoint.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SelectRegion: _components__WEBPACK_IMPORTED_MODULE_10__.SelectRegion,
    SelectMapPoint: _SelectMapPoint__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  data: function data() {
    return {
      // 对话框标题
  ...
  created: function created() {
    var _this = this;
    // 加载区域
    _api_area__WEBPACK_IMPORTED_MODULE_9__.list({
      per_page: 100
    }).then(function (res) {
        ...
        return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _api_area__WEBPACK_IMPORTED_MODULE_9__.list({
                province: province,
                per_page: 100
              });
            case 5:
...
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var lodash_pick__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash.pick */ "./node_modules/lodash.pick/index.js");
...
/* harmony import */ var _SelectMapPoint__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./SelectMapPoint */ "./src/views/store/address/modules/SelectMapPoint.vue");
/* harmony import */ var _common_enum_file_Channel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @/common/enum/file/Channel */ "./src/common/enum/file/Channel.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SelectRegion: _components__WEBPACK_IMPORTED_MODULE_11__.SelectRegion,
    SelectMapPoint: _SelectMapPoint__WEBPACK_IMPORTED_MODULE_12__["default"],
    SelectImage: _components__WEBPACK_IMPORTED_MODULE_11__.SelectImage
  },
  data: function data() {
    return {
      // 对话框标题
      ...
      areas: [],
      province: '',
      channel: _common_enum_file_Channel__WEBPACK_IMPORTED_MODULE_13__["default"].STORE.value
    };
  },
  methods: {
    /**
    ...
    edit: function edit(record) {
      ...
      this.setFieldsValue();
      // 加载区域
      _api_area__WEBPACK_IMPORTED_MODULE_10__.list({
    ...
    setFieldsValue: function setFieldsValue() {
      ...
      record.cascader = [record.province, record.city, record.district];
      this.$nextTick(function () {
        setFieldsValue(lodash_pick__WEBPACK_IMPORTED_MODULE_8___default()(record, ['name', 'contact_name', 'contact_phone', 'cascader', 'address', 'delivery_area_id', 'image_id']));
      });
    ...
    */
    onFormSubmit: function onFormSubmit(values) {
      ...
      var _values$cascader = (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_3__["default"])(values.cascader, 3),
        ...
        district = _values$cascader[2];
      delete values.cascader;
      _api_store_address__WEBPACK_IMPORTED_MODULE_9__.edit(this.record.id, (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_2__["default"])((0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_2__["default"])({}, values), {}, {
        province: province,
        city: city,
        district: district,
        longitude: this.lng,
...
/* harmony import */ var ant_design_vue_es_message__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ant-design-vue/es/message */ "./node_modules/ant-design-vue/es/message/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: {
    // v-model 指定选中项
    value: ant_design_vue_es_util_vue_types__WEBPACK_IMPORTED_MODULE_5__["default"].bool.def(),
    lng: ant_design_vue_es_util_vue_types__WEBPACK_IMPORTED_MODULE_5__["default"].any.def(),
    lat: ant_design_vue_es_util_vue_types__WEBPACK_IMPORTED_MODULE_5__["default"].any.def()
  },
  data: function data() {
    return {
      AMap: null,
      ...
      return (0,_Users_esone_qiu_Sites_caitou_admin_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _amap_amap_jsapi_loader__WEBPACK_IMPORTED_MODULE_4___default().load({
  ...
  methods: {
    ...
    handleOk: function handleOk(e) {
      ...
      if (!this.longitude || !this.latitude) {
        ant_design_vue_es_message__WEBPACK_IMPORTED_MODULE_6__["default"].error('请先点击地图选择点', 3);
        return false;
      }
      if (!this.AMap) ant_design_vue_es_message__WEBPACK_IMPORTED_MODULE_6__["default"].error('地图尚未初始化，请稍后或刷新重试', 3);
